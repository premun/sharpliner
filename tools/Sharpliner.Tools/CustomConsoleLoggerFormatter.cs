...
internal class CustomConsoleLoggerFormatter : ConsoleFormatter
{
    ...
    public CustomConsoleLoggerFormatter(IOptionsMonitor<SimpleConsoleFormatterOptions> options)
        : base(FormatterName)
    {
    ...
    public override void Write<TState>(in LogEntry<TState> logEntry, IExternalScopeProvider? scopeProvider, TextWriter textWriter)
    {
        ...
        var (foreground, background) = GetLogLevelConsoleColors(logLevel);
        ...
        WriteColoredMessage(textWriter, logLevelString, background, foreground);
